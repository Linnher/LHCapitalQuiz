...
# Version Seven - Implementing the user Feedback
...
questions_list = {
    ...
    "What is the capital city of Ireland?": [
        "Dublin", "Belfast", "Limerick"
    ],
    "What is the capital city of Montenegro?": [
        "Podgorica", "Niksic", "Pljevlja"
    ],
    "What is the capital city of North Macedonia?": [
        "Skopje", "Bitola", "Gostivar"
    ],
    "What is the capital city of Bosnia & Herzegovina?": [
    ...
    "What is the capital city of Cyprus?": [
        "Nicosia", "Limassol", "Paralimni"
    ],
    "What is the capital city of Luxembourg?": [
        "Luxembourg", "Echternach", "Diekirch"
    ],
    "What is the capital city of Kosovo?": [
        "Pristina", "Prizren", "Gjilan"
    ],
    "What is the capital city of Andorra?": [
        "Andorra la Vella", "La Massana", "Canillo"
    ],
